...
public class ForestSkiter extends EntitySpider {
    public ForestSkiter(org.bukkit.World world){
        super(((CraftWorld)world).getHandle());
        this.setCustomNameVisible(true);
        this.setCustomName(ChatColor.GREEN+"Forest Skiter");
    ...
    {
        FOREST_SKITER("Skiter", 52, ForestSkiter.class);
