...
public class ForestGuard extends EntityOcelot {
    public ForestGuard(org.bukkit.World world){
        super(((CraftWorld)world).getHandle());
        this.setCustomNameVisible(true);
        this.setCustomName(ChatColor.GREEN+"Forest Guard");
    ...
    {
        FOREST_GUARD("Guard", 98, ForestGuard.class);
